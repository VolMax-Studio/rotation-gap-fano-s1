...
\def \reviewerIINAME{}
\def \reviewerIIORCID{}
\def \dateRECEIVED{06 September 2026}
\def \dateACCEPTED{}
\def \datePUBLISHED{}
...
\def \reviewURL{https://github.com/ReScience/submissions/issues/127}
...
finding demonstrating that equal-distance weighting shifts the mean Fano factor from 2.42 to 2.56 due to
the predominant representation of d=3 experiments (64.3%) in the public repository.
}
